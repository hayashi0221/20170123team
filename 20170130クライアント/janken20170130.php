...
<img src="resource/ch01.png" style="width:50px; height:50px" name="btn0" onclick="btnclick(this)">

<span style="margin-right: 2em;"></span>



<img src="resource/gu01.png" style="width:50px; height:50px" name="btn1" onclick="btnclick(this)">

<span style="margin-right: 2em;"></span>



<img src="resource/pa01.png" style="width:50px; height:50px" name="btn2" onclick="btnclick(this)">
...
document.getElementById('te_sousin').value='choki';
...
document.getElementById('te_sousin').value='guu';
...
document.getElementById('te_sousin').value='paa';
